...
A tool to analyze coding-agent traces to find improvement opportunities and bad patterns.

> Hotwash: a quick after-action debrief. Point it at what an agent did and learn how it could have done better.
...
rollouts), runs analytics + detectors, and renders a report.
